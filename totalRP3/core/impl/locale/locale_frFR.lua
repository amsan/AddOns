...
["CO_SANITIZER_TT"] = "Enlève les tags de couleur et d'image insérés dans les champs non-autorisés des profils de joueur.",
...
["WHATS_NEW_9"] = [=[## Le bouton des recherches sur la carte du monde fait son grand retour

Après avoir essayé d'insérer les recherches sur la carte de Total RP 3 dans le menu des filtres de la carte du monde (ce qui avait tout son sens), nous avons découvert que ça apportait plus de problèmes qu'autre chose ! Nous avons décidé de remettre notre joli bouton pour accéder aux options de recherches (Rappel: vous pouvez changer sa position dans les réglages).

![Interface\AddOns\totalRP3\resources\map_button](256,128)

## Corrections de bug

- Correction d'une erreur Lua qui pouvait survenir lorsque le système de couleur essayait de récupérer une couleur de classe ([ticket #78](https://wow.curseforge.com/projects/total-rp-3/issues/78)).
- Correction d'une erreur Lua pouvant survenir lorsque le système de filtre rencontrait un profil vide ([ticket #76](https://wow.curseforge.com/projects/total-rp-3/issues/76)).
- Correction d'une erreur d'environnement sécurisé qui affichait un message dans la fenêtre de discussion à propos d'une action d'add-on bloquée lorsque l'on ouvrait la carte en plein combat ([ticket #58](https://wow.curseforge.com/projects/total-rp-3/issues/58)).
- Correction d'une erreur d'environnement sécurisé qui empêchait de s'inscrire en file d'attente pour les champs de batailles ([ticket #59](https://wow.curseforge.com/projects/total-rp-3/issues/59))
- Correction d'un problème empêchant l'option de la position du bouton de recherches sur la carte du monde d'être correctement enregistrée.
- Correction de l'ancrage du bouton de recherches sur la carte du monde pour qu'il soit positionné correctement dans chacun des quatre coins de la carte.
- Correction d'une erreur Lua dans le module Prat ([ticket #81](https://wow.curseforge.com/projects/total-rp-3/issues/81)).

## Autres améliorations

- Ajout d'un effet de rechargement au bouton de recherches sur la carte du monde.
- Total RP 3 respectera les options de coloriage du nom en fonction de la classe définies dans les réglages de discussions. À noter que les couleurs personnalisées sont indépendantes des options de discussions du jeu et seront toujours affichées si l'option est activée dans Total RP 3. Vous pouvez toujours désactiver les modifications de Total RP 3 sur un canal en particulier en décochant le canal dans les réglages de discussion ([ticket #79](https://wow.curseforge.com/projects/total-rp-3/issues/79)).
- Total RP 3 enlevait toujours le royaume du nom des joueurs dans les canaux activés, nous avons ajouté une option pour désactiver ce comportement dans les réglages de discussion ([ticket #80](https://wow.curseforge.com/projects/total-rp-3/issues/80)).
- Les profils de joueur existants seront nettoyés au premier lancement de l'add-on.
]=],
}
};
